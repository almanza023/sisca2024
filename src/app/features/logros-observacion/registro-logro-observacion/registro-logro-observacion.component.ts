...
@Component({
  selector: 'app-registro-logro-observacion',
  templateUrl: './registro-logro-observacion.component.html',
  providers: [MessageService],
})
export class RegistroLogroObservacionComponent {
    ...
    nombreModulo: string = 'Módulo Logros Observaciones Finales';
