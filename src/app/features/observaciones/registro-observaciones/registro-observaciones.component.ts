...
import { LogrosObservacionService } from 'src/app/core/services/logros-observacion.service';
import { ObservacionesService } from 'src/app/core/services/observaciones.service';
...
export class RegistroObservacionesComponent {
    ...
    nombreModulo: string = 'Registro de Observaciones Finales';
    ...
    constructor(
        private convivenciaService: ObservacionesService,
        private logroService: LogrosObservacionService,
